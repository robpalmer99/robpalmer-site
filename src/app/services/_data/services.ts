  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          'Conversion rate optimization isn\'t a single-page exercise. Every step in your funnel is a conversion point \u2014 and a potential copy leak. I optimize copy across all of them, with the framework that fits each asset type. And if the leak isn\'t one page but the whole creative testing loop, that\'s a different engagement \u2014 that\'s when you <a href="/blog/hire-a-creative-strategist">hire a creative strategist</a> to own the system rather than patch the asset.',
        bullets: [
