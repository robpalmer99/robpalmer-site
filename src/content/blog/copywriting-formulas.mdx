...
tags: ["copywriting formulas", "AIDA", "PAS", "direct response", "copywriting", "sales copy"]
published: true
...
These formulas were not invented in a boardroom. They were discovered through decades of testing — millions of split tests across [direct mail](/blog/direct-mail-copywriting), advertising, [email](/blog/email-copywriting), and [digital sales pages](/blog/how-to-write-a-sales-page). They represent the accumulated knowledge of what sequence works when the goal is to move a reader from scepticism to action. For definitions of every term used in these frameworks, see the [direct response copywriting glossary](/blog/direct-response-copywriting-glossary).

Over [40 years and $523 million in tracked results](/about), I have used every formula on this list — sometimes individually, sometimes in combination. Here are the 12 that appear most frequently in the highest-performing copy I have written and studied.
...
**Attention:** Capture the reader's attention with a compelling [headline](/blog/how-to-write-a-headline) or opening. This is the gate — if it fails, nothing else matters. (The opening line is its own craft — I have catalogued the [copywriting hooks](/blog/copywriting-hooks) that consistently earn that first second of attention.)
...
If you need help applying these formulas to your specific [sales pages](/services/sales-page-copywriter), [VSLs](/services/vsl-copywriter), [email sequences](/services/email-copywriter), or [sales funnels](/services/sales-funnel-copywriter), [book a free strategy call](/call) to discuss your project.
