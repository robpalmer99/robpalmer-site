...
**Name three direct response writers whose work you study.** If they cannot name three, they do not have Brain 1. The names should include some combination of Schwartz, Halbert, Hopkins, Caples, Sugarman, Collier, Bencivenga, Carlton, Georgi, Goff, Bond, Halpern, or other real DR operators. If they name [Alex Hormozi](/blog/copywriting-influencers) and nobody else, that is a one-brain answer.
