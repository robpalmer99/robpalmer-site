...
description: "Learn how to write email subject lines that earn opens using 17 battle-tested formulas, A/B testing frameworks, and formatting rules — from a direct-response copywriter with $523M+ in tracked results."
date: "2025-04-08"
...
Over 30 years of writing [email copy](/blog/email-copywriting) across health, finance, e-commerce, and information products — contributing to $523 million in tracked results — I have tested thousands of subject lines. The pattern is consistent: change the subject line on an identical email and open rates swing by 50 to 200 percent. Change the body copy and clicks move by 10 to 20 percent. The subject line is not just the most important element — it is the element that makes everything else possible.
