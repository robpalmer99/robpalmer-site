...
tags: ["email subject lines", "email copywriting", "email marketing", "open rates", "direct response", "copywriting"]
published: true
...
The reader was interested enough to add to cart but did not complete the purchase. Be direct, helpful, and remove friction. Cart abandonment subject lines are among the highest-ROI emails in [e-commerce copywriting](/blog/ecommerce-copywriting) because the buyer intent is already established.
