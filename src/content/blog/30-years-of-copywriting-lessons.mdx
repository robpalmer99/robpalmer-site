...
description: "After 30+ years and $523M in tracked results, here are the copywriting lessons that only come from decades in the trenches — the ones no course or book will teach you."
date: "2026-02-26"
...
The [Belron/Safelite campaign](/blog/523m-copywriting-campaign) is the clearest illustration of this principle. Five previous copywriters had failed to produce a campaign that met performance targets. They were all competent writers. Their copy was clean, professional, and logically structured. But they had all started from the same flawed assumption — that windshield replacement was a convenience decision. The research I conducted revealed something entirely different: the real driver was safety. That single insight, which came from deep research rather than clever writing, was worth $523 million.
