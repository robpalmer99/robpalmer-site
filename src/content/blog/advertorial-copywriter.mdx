...
faqs:
  ...
  - question: "How long does Rob take to deliver an advertorial?"
    answer: "Most single advertorials take 2-3 weeks from kickoff to final draft, with most of that time on research and big-idea work. Tight turnarounds are possible for warm markets where Rob already has deep reference material in his Obsidian copywriting brain. Rush timelines compress research, which directly impacts cold-traffic performance."
  - question: "What is Rob process for writing a high-converting advertorial?"
...
### Brain 1 — Rob's copywriting brain
...
Rob has built a suite of proprietary Claude Code [copywriting skills](/blog/claude-code-copywriting-skills) specifically for advertorial work — research prompts, big-idea generators, hook libraries, compliance checkers, and handoff-aware drafting tools. Together they augment Claude Code's brain with frameworks and evaluation criteria from real campaigns, compressing what used to be weeks of research and drafting into days without sacrificing voice or depth. Most copywriters either refuse to use AI or let it flatten their work into generic mush. Rob uses AI as a force multiplier on top of the craft, not a replacement for it.

### Brain 3 — Rob's Obsidian copywriting brain

The third edge is a 1,239-file Obsidian copywriting brain spanning everything from the old direct response masters through today's cutting-edge AI marketing strategies — proven advertorials, hooks, leads, frameworks, and research across every major direct response vertical. When Rob sits down to write an advertorial for your market, he is not starting from a blank page. He is starting from pattern recognition: what has worked in your vertical, what has failed, what the angles and ideas look like when they scale, and what the compliance landmines are. That pattern recognition is not something you can fake or buy — it is the compounded output of four decades of work, indexed and instantly retrievable.
...
- **Info products and courses** — [info product advertorial copy](/verticals/info-product-copywriter) for coaches, course creators, and digital publishers. Story-lead and personality-lead work especially well here, and Rob has deep experience with both.
...
2. **Big idea and hook generation.** The single highest-leverage decision in any advertorial. Rob generates multiple candidate big ideas, stress-tests them against Obsidian-brain benchmarks and cold-traffic hook patterns, and picks the angle with the highest belief-building potential for your specific audience.
...
4. **Compliance sweep.** Meta, Google, and platform-specific policy pass, plus vertical-specific claim review for health, finance, or supplement offers. Most advertorials that get banned could have been saved with a 60-minute review before launch. Rob does that review as a matter of process.
...
The whole process typically takes 2-3 weeks per advertorial, with tighter turnarounds possible in verticals where Rob's Obsidian copywriting brain already has deep coverage.
...
If you need an advertorial that holds up on cold traffic — built by someone who has been writing direct response for 40+ years, uses Claude Code with proprietary advertorial skills, and brings a 1,239-file Obsidian copywriting brain of proven patterns to your project — [book a strategy call with Rob](/contact).
...
<FAQItem question="How long does Rob take to deliver an advertorial?">
Most single advertorials take 2-3 weeks from kickoff to final draft, with most of that time on research and big-idea work. Tight turnarounds are possible for warm markets where Rob already has deep reference material in his Obsidian copywriting brain. Rush timelines compress research, which directly impacts cold-traffic performance.
</FAQItem>

<FAQItem question="What is Rob process for writing a high-converting advertorial?">
