...
description: "Long vs. short-form copy: which converts better? Practical guide backed by 40+ years of direct-response results and data."
metaTitle: "Long-Form vs Short-Form Copy: When Each One Wins"
metaDescription: "Long-form vs short-form copy — which converts better, backed by 40+ years of direct-response results. A guide to choosing the right length for each situation."
date: "2026-02-26"
...
I have been writing direct-response copy for over 40 years, generating $523 million in tracked results across health, financial, SaaS, e-commerce, and information marketing. In that time, I have written sales pages north of 8,000 words that crushed their controls, and I have written 400-word landing pages that did the same. The difference was never about some universal law of copy length. It was about matching the format to the sale.
...
Here is what four decades of testing have taught me about copy length: the real enemy is never too many words. It is too many irrelevant words.
...
That is not a theory. It is the architecture behind the highest-performing funnels I have built across 40+ years and $523 million in tracked results.

If you are unsure whether your next project needs long-form copy, short-form copy, or a strategic combination of both — [book a free strategy call](/call) and I will walk you through the copy architecture that fits your offer, your audience, and your funnel. No templates. No guesswork. Just the format that converts.
