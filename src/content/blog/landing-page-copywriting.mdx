...
tags: ["landing page", "copywriting", "conversion", "direct response", "lead generation", "CRO"]
published: true
...
A **[sales page](/blog/how-to-write-a-sales-page)** is a complete persuasion document. It takes the visitor through the entire buying decision — from problem awareness through desire building to close. A landing page may be the entry point to a [funnel](/blog/what-is-a-sales-funnel) that eventually leads to a sales page, but the landing page itself has a simpler, lower-friction conversion goal.
