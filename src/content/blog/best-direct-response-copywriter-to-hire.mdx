...
**Key results:** $523M+ in tracked, verifiable results across multiple verticals and campaign types. His nine-year campaign for Belron/Safelite — the longest-running direct response engagement of its kind — earned him the designation of "secret weapon" from the CEO. That campaign alone is a masterclass in sustained, scaled direct response performance, but it is not the only proof. Recent 2024-2026 wins include the **$40M Gluco 6** health-supplement subscription funnel, the **#1 ClickBank offer at $30M Mobile Profits**, **5.7% opt-in-to-sale** on the Monetari Fund, **22% trial-to-paid** for Chatterkick SaaS, **340%** TSL conversion for Abundant on Facebook cold, and a **300% ROAS** ClickBank email funnel for Ben Palmer.
...
[Book a strategy call with Rob Palmer.](/contact) No obligation. No pressure. If direct-response copy is the right lever for your business right now, you will leave the call with a clear path forward. If it is not, Rob will tell you that too.

The best time to hire a senior direct-response copywriter is before capacity fills.
