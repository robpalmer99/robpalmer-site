...
The headline is the smallest piece of copy with the largest impact on results. It is also the element that separates professional [direct-response copywriters](/services/direct-response-copywriter) from writers who are merely talented with words.
